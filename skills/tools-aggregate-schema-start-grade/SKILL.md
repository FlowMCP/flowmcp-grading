...
1. **Parse JSON-Response** des Evaluator-Skills strikt gegen
   `prompts/output-schemas/tools-aggregate-schema.schema.json`. Bei Parse-Fehler ODER
...
- **PRD-15** — Evaluator-Skill (`tools-aggregate-schema-evaluate`), wird hier orchestriert
