<!-- Area: 04 tools-aggregate-namespace | Persona: Neutral | Spec: spec extension 1.2 -->
...
1. {{NAMESPACE_ABOUT_PATH}}    — Namespace About page
2. {{DOMAIN_KNOWLEDGE_PATH}}   — Domain knowledge doc (Spec 10 §3, e.g. crypto.md)
